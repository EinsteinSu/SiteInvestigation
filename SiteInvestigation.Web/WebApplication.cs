...
namespace SiteInvestigation.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class SiteInvestigationAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private SiteInvestigation.Module.SiteInvestigationModule module3;
        private SiteInvestigation.Module.Web.SiteInvestigationAspNetModule module4;
        ...
        private Module.MyAuthenticationStandard myAuthenticationStandard1;
        private DevExpress.ExpressApp.Workflow.WorkflowModule workflowModule;

        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static SiteInvestigationAspNetApplication() {
        ...
        #endregion
        public SiteInvestigationAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void SiteInvestigationAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new SiteInvestigation.Module.SiteInvestigationModule();
            this.module4 = new SiteInvestigation.Module.Web.SiteInvestigationAspNetModule();
            ...
            this.myAuthenticationStandard1 = new SiteInvestigation.Module.MyAuthenticationStandard();
            ((System.ComponentModel.ISupportInitialize)(this)).BeginInit();
            // 
            // securityStrategyComplex1
            // 
            this.securityStrategyComplex1.AllowAnonymousAccess = false;
            this.securityStrategyComplex1.Authentication = this.myAuthenticationStandard1;
            ...
            // 
            // myAuthenticationStandard1
            // 
            this.myAuthenticationStandard1.LogonParametersType = typeof(DevExpress.ExpressApp.Security.AuthenticationStandardLogonParameters);
            // 
            // SiteInvestigationAspNetApplication
            // 
            this.ApplicationName = "SiteInvestigation";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.SiteInvestigationAspNetApplication_DatabaseVersionMismatch);
